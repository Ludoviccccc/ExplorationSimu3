...
if __name__=='__main__':
    ...
    for k in [2]:
        for s in [1]:  
            ...
            hist_diversity(content_rand['memory_perf'],content_imgep['memory_perf'], name=f'images/time_k_{k}_s_{s}',num_row=7,title=f'ddr miss ratio for imgep k={k}. mutual vs isolation')
